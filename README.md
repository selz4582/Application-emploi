...
Depuis le dossier, le bouton **Télécharger le courriel .eml** enregistre d’abord le brouillon
puis produit un message compatible avec les logiciels de messagerie. Le CV sélectionné et la
lettre au format texte y sont joints localement. Cette action ne transmet et n’envoie rien :
l’utilisateur ouvre le fichier, effectue une dernière vérification et déclenche lui-même l’envoi.
...
Le document original peut être téléchargé depuis sa carte ou directement depuis le dossier
de candidature. Le serveur restitue son nom d’origine sans révéler son nom de stockage ni son
chemin local, et refuse tout fichier situé hors du dossier réservé aux CV. Cela permet de
récupérer la bonne pièce jointe avant l’envoi manuel du courriel.
